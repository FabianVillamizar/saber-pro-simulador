...
const BLOQUE_A_REGLA = {
  ...
  causativo: 'ing-r-causative',
  estar_acostumbrado_a: 'ing-r-used-to',
...
const LABEL = {
  ...
  'ing-r-causative': 'el causativo (have / get something done)',
  'ing-r-used-to': 'used to / be used to / get used to',
